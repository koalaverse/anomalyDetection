...
This process could be streamlined by using the `hmat` command to create the histogram matrix. This command can take raw data, a state vector, or calculated Mahalanobis distances as input, and can be added onto using the `+` operator. By default, `hmat` displays the top 20 most anomalous blocks.

```{r, fig.align='center', fig.width=9, fig.height=6}
state_vec %>% 
  hmat(input = "SV", normalize = TRUE) +
